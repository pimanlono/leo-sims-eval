...
files = {
    "S1": "graficas_starlink/elevation35/graficas_relays/200s/path/data/histogram_missed_path_changes.txt",
    "K1": "graficas_kuiper/elevation35/graficas_relays/200s/path/data/histogram_missed_path_changes.txt",
    "T1": "graficas_telesat/elevation40/graficas_relays/200s/path/data/histogram_missed_path_changes.txt"
}
...
plt.title("algorithm_one_only_gs_relays", fontsize=14)
plt.legend()
plt.grid(axis="y", linestyle="--", alpha=0.7)

output_file="./figure_histogram_missed_changes_relays.png"
