...
//SPE-modification
#include "../model/leo-kuiper-constants.h"
...
LeoChannelHelper::SetConstellation (std::string constellation)
{
  ...
  else if (constellation == "KuiperGateway") //SPE-modification
    {
      SetConstellationAttributes (LEO_KUIPER_GATEWAY_EIRP,
      				  LEO_KUIPER_GATEWAY_ELEVATION_ANGLE,
      				  LEO_KUIPER_GATEWAY_FSPL,
      				  LEO_KUIPER_GATEWAY_ATMOSPHERIC_LOSS,
      				  LEO_KUIPER_GATEWAY_LINK_MARGIN,
      				  LEO_KUIPER_GATEWAY_DATA_RATE,
      				  LEO_KUIPER_GATEWAY_RX_ANTENNA_GAIN,
      				  0.0
      );
    }
  else if (constellation == "KuiperUser") //SPE-modification
    {
      SetConstellationAttributes (LEO_KUIPER_USER_EIRP,
      				  LEO_KUIPER_USER_ELEVATION_ANGLE,
      				  LEO_KUIPER_USER_FSPL,
      				  LEO_KUIPER_USER_ATMOSPHERIC_LOSS,
      				  LEO_KUIPER_USER_LINK_MARGIN,
      				  LEO_KUIPER_USER_DATA_RATE,
      				  LEO_KUIPER_USER_RX_ANTENNA_GAIN,
      				  0.0
      );
    }
  else
